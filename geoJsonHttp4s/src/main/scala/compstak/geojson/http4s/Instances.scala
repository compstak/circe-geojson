...
object instances {
  ...
  implicit def entityDecoderForGeoJson[F[_]: Concurrent, N: Eq: Decoder, P: Decoder]: EntityDecoder[F, GeoJson[N, P]] =
  ...
  implicit def entityDecoderForGeoJsonGeometry[F[_]: Concurrent, N: Eq: Decoder]: EntityDecoder[F, GeoJsonGeometry[N]] =
  ...
  implicit def entityDecoderForPoint[F[_]: Concurrent, N: Decoder]: EntityDecoder[F, Point[N]] =
    jsonOf[F, Point[N]]
  ...
  implicit def entityDecoderForMultiPoint[F[_]: Concurrent, N: Decoder]: EntityDecoder[F, MultiPoint[N]] =
  ...
  implicit def entityDecoderForLineString[F[_]: Concurrent, N: Decoder]: EntityDecoder[F, LineString[N]] =
  ...
  implicit def entityDecoderForMultiLineString[F[_]: Concurrent, N: Decoder]: EntityDecoder[F, MultiLineString[N]] =
  ...
  implicit def entityDecoderForPolygon[F[_]: Concurrent, N: Decoder: Eq]: EntityDecoder[F, Polygon[N]] =
    jsonOf[F, Polygon[N]]
  ...
  implicit def entityDecoderForMultiPolygon[F[_]: Concurrent, N: Decoder: Eq]: EntityDecoder[F, MultiPolygon[N]] =
  ...
  implicit def entityDecoderForGeometryCollection[F[_]: Concurrent, N: Decoder: Eq]
    : EntityDecoder[F, GeometryCollection[N]] =
  ...
  implicit def entityDecoderForFeature[F[_]: Concurrent, N: Decoder: Eq, P: Decoder: Encoder]
  ...
  implicit def entityDecoderForFeatureCollection[F[_]: Concurrent, N: Decoder: Eq, P: Decoder: Encoder]
